...
enum class SyncMetric(
    val key: String,
    val label: String,
    /** Whether the Google Health API currently supports writing this metric. */
    val googleHealthSupported: Boolean = false,
) {
    HEART_RATE("heart_rate", "Heart Rate"),
    RESTING_HEART_RATE("resting_heart_rate", "Resting Heart Rate"),
    SLEEP("sleep", "Sleep", googleHealthSupported = true),
    ...
    WEIGHT("weight", "Weight & Body Fat", googleHealthSupported = true),
    WORKOUTS("workouts", "Workouts", googleHealthSupported = true),
